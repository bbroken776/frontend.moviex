  ...
  return (
    <div className="flex w-full max-w-4xl mx-auto bg-mineshaft-900/50 backdrop-blur-lg rounded overflow-hidden shadow-lg shadow-mineshaft-950">
      <div className="hidden sm:block w-1/2">
        <img src="/images/popcorn.png" alt="Register Illustration" className="w-full h-full object-cover" />
      </div>
        ...
        <form onSubmit={handleSubmit(handleRequest)} className="space-y-8">
          <div className="flex flex-col gap-4">
            <FormGroup>
              ...
              />
              {errors.firstName && <span className="text-amber-300 text-xs ml-1">{errors.firstName.message}</span>}
            </FormGroup>
            ...
            <FormGroup>
              <input
                ...
                className="w-full px-4 py-2 bg-mineshaft rounded placeholder-gray-400 text-gray-100 outline-none focus:bg-amber-400/5"
              />
              {errors.lastName && <span className="text-amber-300 text-xs ml-1">{errors.lastName.message}</span>}
            </FormGroup>
